<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MainPageContentLeft.aspx.cs"
    Inherits="MainPage_MainPageContentLeft" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function imgRightClick(obj) {
            ...
            if (mainFrameSet) {
                mainFrameSet.setAttribute("cols", "200,*");
                obj.style.display = "none";
        ...
        function SetSplitPanelHeight() {
            if (parent && parent.parent && parent.parent.document && GetParentObject("iframe", "frmContentMain")) {
...
<body style="background-color: White; margin: 0px auto; padding: 0px auto;">
    <table id="tbMain" style="margin: 0px auto" cellpadding="0" cellspacing="0">
        <tr>
            <td style="width: 8px; background-image: url(../images/FrameConfig/vpagebg.gif);"
                valign="middle">
                <img id="imgLeft" alt="" title="点击隐藏业务组织版块" width="8px;" height="42px" src="../images/FrameConfig/varrowleft.png"
                    onclick="return imgLeftClick(this);" onmouseover="return imgLeftMouseOver(this);"
                    onmouseout="return imgLeftMouseOut(this);" /><img id="imgRight" alt="" title="点击显示业务组织版块"
