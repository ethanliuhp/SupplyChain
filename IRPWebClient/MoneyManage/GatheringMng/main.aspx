<%@ Page Language="C#" AutoEventWireup="true" CodeFile="main.aspx.cs" Inherits="MoneyManage_GatheringMng_main" %>
    ...
    <div id="divMain"   >
        ...
        <div id="divContent">
            ...
            <div id="divDetailInfo">
                <iframe  id="ifrDetailInfo"   src="Detail.htm" frameborder="0" scrolling="auto" marginheight="0" marginwidth="0"  ></iframe>
            </div>
        </div>
    </div>
    </form>
