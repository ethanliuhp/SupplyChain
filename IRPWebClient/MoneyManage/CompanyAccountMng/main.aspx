<%@ Page Language="C#" AutoEventWireup="true" CodeFile="main.aspx.cs" Inherits="MoneyManage_CompanyAccountMng_main" %>
...
<body style=" width:100%; height:100%; margin:0px; padding:0px; ">
        ...
        <div id="divContent">
            <div id="divList"  >
                 <div id="divMasterList">
                    <fieldset>
                        <legend align="left" ><%=CompanyAccountType.ToString()%></legend>
    ...
    <asp:HiddenField runat="server" ID="hdCompanyType" Value="0" />
    </form>
</body>
</html>
