...
{
    public class CReportQueryByAssert
    {
        static IFramework framework;
        private string mainViewName = "查询技术系统统计报表";

        public CReportQueryByAssert(IFramework fw)
        {
            if (framework == null)
            {
                framework = fw;
        ...
        private void Find()
        {
            ...
            {
                VReportQuery mainView = new VReportQuery();
