...
{
    public partial class VLossOutQuery : TBasicDataView
    {
        private MLossOut  model = new MLossOut();

        public VLossOutQuery()
        {
            InitializeComponent();
            InitEvent();
            InitData();
        ...
        public void dgDetail_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1 && e.ColumnIndex > -1)
            {
                ...
                {
                    string code = billId;
                    VLossOut lossOut = new VLossOut( );
                    lossOut.StartByID(billId);
                    lossOut.ShowDialog();
                }
        ...
        void dgDetail_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvCell.OwningColumn.Name == colCode.Name)
            {
                ...
                //vpro.Preview();
                LossOut  lossOut = model.GetObjectById(dgvCell.Value.ToString());
                VLossOut vloss = new VLossOut();
                vloss.theLossOut = lossOut;
                vloss.Preview();
            }
        ...
        void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet dataSet = model.LossOutSrv.LossOutQuery(condition);
