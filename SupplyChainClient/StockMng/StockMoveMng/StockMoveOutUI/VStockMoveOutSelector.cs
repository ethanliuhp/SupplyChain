...
{
    public partial class VStockMoveOutSelector : TBasicDataView
    {
        ...
        public VStockMoveOutSelector(EnumStockExecType execType)
        {
        ...
        {
            VBasicDataOptr.InitMoveProject(cboProjectName, true);
        }
        ...
        void dgMaster_SelectionChanged(object sender, EventArgs e)
        {
            dgDetail.Rows.Clear();
            Clear();
            StockMoveOut master = dgMaster.CurrentRow.Tag as StockMoveOut;
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow var in this.dgDetail.Rows)
            {
                ...
                {
                    StockMoveOutDtl dtl = var.Tag as StockMoveOutDtl;
                    dtl.IsSelect = true;
                }               
            }
        ...
        void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (cboProjectName.SelectedItem != null && cboProjectName.SelectedItem.ToString() != "")
            {
                oq.AddCriterion(Expression.Eq("MoveInProjectName", cboProjectName.SelectedItem.ToString()));
            }
            ...
            try
            {
                list = model.StockMoveSrv.GetStockMoveOut(oq);
                ShowMasterList(list);
            } catch (Exception ex)
            {
        ...
        private void ShowMasterList(IList masterList)
        {
            ...
            foreach (StockMoveOut master in masterList)
            {
                ...
                dgMaster[colDgMasterMoveInProject.Name, rowIndex].Value = master.MoveInProjectName;
