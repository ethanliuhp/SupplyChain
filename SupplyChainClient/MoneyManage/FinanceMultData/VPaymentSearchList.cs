...
{
    public partial class VPaymentSearchList : SearchList
    {
        private CPaymentMng cPaymentMng;
        ...
        public VPaymentSearchList(CPaymentMng cPaymentMng)
        {
            InitializeComponent();
            this.cPaymentMng = cPaymentMng;
            InitDgSearch();
        }
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (master != null)
            {
                cPaymentMng.Find(master.Code, master.Id, master.IfProjectMoney);
            }
        }
