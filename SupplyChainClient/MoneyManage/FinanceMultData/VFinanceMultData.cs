...
{
    public partial class VFinanceMultData : TMasterDetailView
    {
        ...
        public VFinanceMultData(AccountType accountType)
        {
            InitializeComponent();
            arrControl = new Control[]  {
                this.txtCivilAndSetUpBalance,this.txtCivilAndSetUpPayout,this.txtCivilProjectBalance,this.txtContractGrossProfit,
                this.txtExchangeMaterialRemain,this.txtLowValueConsumableRemain,this.txtMainBusinessTax,this.txtMaterialCost,
                this.txtMaterialRemain,this.txtMechanicalCost,this.txtOtherDirectCost,this.txtPersonCost,this.txtSetUpPayout,
                this.txtSetUpProjectBuild,this.txtSubProjectPayout,this.txtTempDeviceRemain
            };
            InitDate();
            InitEvent();
