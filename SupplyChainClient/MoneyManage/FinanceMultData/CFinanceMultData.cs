        ...
        public object Excute(params object[] args)
        {
            ...
            else
            {
                ...
                switch (execType)
                {
                    ...
                    case FinanceMultDataExecType.施工节点进度查询:
                        {
                            string sViewCaption = "施工节点进度查询";
                            VConstructNodeQuery viewMain = framework.GetMainView(sViewCaption) as VConstructNodeQuery;
                            if (viewMain == null)
                            {
                                viewMain = new VConstructNodeQuery();
                                framework.AddMainView(viewMain);
                                viewMain.ViewCaption = sViewCaption;
                            }
                            viewMain.ViewShow();
