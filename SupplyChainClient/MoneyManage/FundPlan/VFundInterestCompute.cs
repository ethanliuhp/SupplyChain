...
{
    public partial class VFundInterestCompute : TMasterDetailView
    {
        ...
        private void InitGrid()
        {
            ...
            gdInterestDetail.DefaultRowHeight = 25;
        ...
        {
            if (currentMaster == null || currentMaster.Details.Count == 0)
            {
                return false;
            }

            currentMaster.Temp1 = "利息计算";
        ...
        private void btnGetData_Click(object sender, EventArgs e)
        {
            ...
            currentMaster = mOperate.FinanceMultDataSrv.GetFundAssessmentData(currentMaster, 1);
