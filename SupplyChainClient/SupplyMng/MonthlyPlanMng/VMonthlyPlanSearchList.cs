...
{
    public partial class VMonthlyPlanSearchList : SearchList
    {
        private CMonthlyPlanMng cMonthlyPlanMng;

        public VMonthlyPlanSearchList(CMonthlyPlanMng cMonthlyPlanMng)
        {
            InitializeComponent();
            this.cMonthlyPlanMng = cMonthlyPlanMng;
            InitDgSearch();
        }
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            MonthlyPlanMaster monthlyMaster = dgSearchResult.Rows[e.RowIndex].Tag as MonthlyPlanMaster;
            //object code = dgSearchResult.Rows[e.RowIndex].Cells["Code"].Value;
            if (monthlyMaster != null)
            {
                //cMonthlyPlanMng.Find(code.ToString());
                cMonthlyPlanMng.Find(monthlyMaster.Code, (EnumMonthlyType)Enum.Parse(typeof(EnumMonthlyType), monthlyMaster.Special),monthlyMaster.Id);
            }
        }
