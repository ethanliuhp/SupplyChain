...
{
    public partial class VSupplyOrderSearchCon : BasicUserControl
    {
        private MSupplyOrderMng model = new MSupplyOrderMng();
        private VSupplyOrderSearchList searchList;
        private EnumSupplyType supplyType;

        public VSupplyOrderSearchCon(VSupplyOrderSearchList searchList, EnumSupplyType supplyType)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.SupplyOrderSrv.GetSupplyOrder(oq);
