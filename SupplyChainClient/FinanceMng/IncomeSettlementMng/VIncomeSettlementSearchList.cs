...
{
    public partial class VIncomeSettlementSearchList : SearchList
    {
        private CIncomeSettlementMng cIncomeSettlementMng;

        public VIncomeSettlementSearchList(CIncomeSettlementMng cIncomeSettlementMng)
        {
            InitializeComponent();
            this.cIncomeSettlementMng = cIncomeSettlementMng;
            InitDgSearch();
        }
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (code != null)
            {
                cIncomeSettlementMng.Find(code.ToString(),ClientUtil.ToString(Id));
            }
        }
        ...
        public void RefreshData(IList lst)
        {
            ...
            foreach (IncomeSettlementMaster obj in lst)
            {
