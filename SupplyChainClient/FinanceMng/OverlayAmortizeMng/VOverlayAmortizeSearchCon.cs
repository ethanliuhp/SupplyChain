...
{
    public partial class VOverlayAmortizeSearchCon : BasicUserControl
    {
        private MOverlayAmortizeMng model = new MOverlayAmortizeMng();
        private VOverlayAmortizeSearchList searchList;

        public VOverlayAmortizeSearchCon(VOverlayAmortizeSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.OverlayAmortizeSrv.GetOverlayAmortizeMaster(oq);
