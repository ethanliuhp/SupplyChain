...
{
    public partial class VExpensesSettleSearchCon : BasicUserControl
    {
        private MExpensesSettleMng model = new MExpensesSettleMng();
        private VExpensesSettleSearchList searchList;

        public VExpensesSettleSearchCon(VExpensesSettleSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.ExpensesSettleSrv.GetExpensesSettle(oq);
