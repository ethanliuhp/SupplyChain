...
{
    public partial class VConCheckSearchList : SearchList
    {
        private CConCheck cConCheck;

        public VConCheckSearchList(CConCheck cConCheck)
        {
            InitializeComponent();
            this.cConCheck = cConCheck;
            InitDgSearch();
        }
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                cConCheck.Find(code.ToString(), id.ToString());
            }
        }
        ...
        public void RefreshData(IList list)
        {
            //从Model中取数
            dgSearchResult.Rows.Clear();
            foreach (ConcreteCheckingMaster obj in list)
            {
                ...
                dr.Cells["SumQuantity"].Value = obj.SumVolume;
