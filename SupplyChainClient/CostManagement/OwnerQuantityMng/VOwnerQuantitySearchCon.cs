...
{
    public partial class VOwnerQuantitySearchCon : BasicUserControl
    {
        private MOwnerQuantityMng model = new MOwnerQuantityMng();
        private VOwnerQuantitySearchList searchList;

        public VOwnerQuantitySearchCon(VOwnerQuantitySearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.OwnerQuantitySrv.GetOwnerQuantity(oq);
