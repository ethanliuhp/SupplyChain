...
{
    public partial class VContractExcuteSearchCon : BasicUserControl
    {
        private MContractExcuteMng model = new MContractExcuteMng();
        private VContractExcuteSearchList searchList;

        public VContractExcuteSearchCon(VContractExcuteSearchList searchList)
        {
        ...
        {
            this.dtpDateBegin.Value = ConstObject.LoginDate.AddYears(-1);
        ...
        private void InitEvent()
        {
            ...
            this.btnSearch.Click += new EventHandler(btnOK_Click);
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            //oq.AddCriterion(Expression.Eq("CreatePerson.Id", ConstObject.LoginPersonInfo.Id));
            ...
            IList list = model.ContractExcuteSrv.GetContractExcute(oq);
            searchList.RefreshData(list);
            this.btnSearch.FindForm().Close();
        }
