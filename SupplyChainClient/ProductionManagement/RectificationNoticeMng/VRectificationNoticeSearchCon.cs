...
{
    public partial class VRectificationNoticeSearchCon : BasicUserControl
    {
        private MRectificationNoticeMng model = new MRectificationNoticeMng();
        private VRectificationNoticeSearchList searchList;
        public VRectificationNoticeSearchCon(VRectificationNoticeSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.RectificationNoticeSrv.GetRectificationNotice(oq);
