...
{
    public partial class VWeatherSearchCon : BasicUserControl
    {
        private MWeatherMng model = new MWeatherMng();
        private VWeatherSearchList searchList;
        public VWeatherSearchCon(VWeatherSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.WeatherSrv.GetWeather(oq);
