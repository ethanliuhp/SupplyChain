...
{
    public partial class VConstructionSearchCon : BasicUserControl
    {
        private MConstruction model = new MConstruction();
        private VConstructionSearchList searchList;
        public VConstructionSearchCon(VConstructionSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.ConstructionSrv.GetConstruction(oq);
