...
{
    public partial class VMaterialCollectionSearchList : SearchList
    {
        private CMaterialCollection cMaterialCollection;

        public VMaterialCollectionSearchList(CMaterialCollection cMaterialCollection)
        {
            InitializeComponent();
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (code != null)
            {
                cMaterialCollection.Find(code.ToString(), ClientUtil.ToString(Id));
            }
        }
        ...
        public void RefreshData(IList list)
        {
            //从Model中取数
            dgSearchResult.Rows.Clear();
            foreach (MaterialCollectionMaster obj in list)
            {
