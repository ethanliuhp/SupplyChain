...
{
    public partial class VMaterialRentalSettlementSearchCon : BasicUserControl
    {
        private MMatRentalMng model = new MMatRentalMng();
        private VMaterialRentalSettlementSearchList searchList;
        public VMaterialRentalSettlementSearchCon(VMaterialRentalSettlementSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.MatMngSrv.GetMaterialRentalSettlement(oq);
