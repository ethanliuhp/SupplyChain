...
namespace Application.Business.Erp.SupplyChain.CostManagement.CostItemMng.Domain
{
    ...
    public class SubjectCostQuota
    {
        ...
        private bool _mainResourceFlag;
        private Iesi.Collections.Generic.ISet<ResourceGroup> _listResources = new Iesi.Collections.Generic.HashedSet<ResourceGroup>();


        /// <summary>
        /// 主资源标志
        /// </summary>
        public virtual bool MainResourceFlag
        {
            get { return _mainResourceFlag; }
            set { _mainResourceFlag = value; }
        }
        /// <summary>
        /// 资源组
        /// </summary>
        public virtual Iesi.Collections.Generic.ISet<ResourceGroup> ListResources
        {
