...
namespace Application.Business.Erp.SupplyChain.MoneyManage.FinanceMultData.Domain
{
    ...
    public class FundPlanningMaster : BaseMaster
    {
        ...
        public virtual string FinancePerson
        {
            get { return _financePerson; }
            set { _financePerson = value; }
        }

        private string _businessPerson;
        public virtual string BusinessPerson
        {
            get { return _businessPerson; }
            set { _businessPerson = value; }
        }

        private string _technologyPerson;
        public virtual string TechnologyPerson
        {
            get { return _technologyPerson; }
            set { _technologyPerson = value; }
        }

        private string _directorPerson;
        public virtual string DirectorPerson
        {
            get { return _directorPerson; }
            set { _directorPerson = value; }
        }
