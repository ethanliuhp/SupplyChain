...
namespace Application.Business.Erp.SupplyChain.MoneyManage.FinanceMultData.Service
{
    public interface IFinanceMultDataSrv
    {
        ...
        IList GetPaymentRequest(ObjectQuery oQuery);
        IList GetPaymentMasterByRequestBill(PaymentRequest requestBill);
        PaymentMaster GetPaymentMasterById(string id);
        PaymentMaster GetPlanPayMasterById(string id);
        CurrentProjectInfo GetProjectInfoById(string id);
        PaymentMaster SavePaymentMaster(PaymentMaster obj);
        PaymentRequest SavePaymentRequest(PaymentRequest obj);
        PaymentRequest UpdatePaymentRequest(PaymentRequest obj);
        void DeletePaymentRequest(PaymentRequest obj);
        void DeletePaymentRequestList(IList obj);
        ...
        /// <returns></returns>
        bool DeleteObjects(IList objList);
        ...
        FundPlanningMaster ClearFundSchemeDetail(string schId);
