...
namespace Application.Business.Erp.SupplyChain.BasicData.SystemParamMng.Service
{
    public class SystemParamSrv : ISystemParamSrv
    {
        private IDao _Dao;
        ...
        virtual public IList GetObjects(Type aType)
        {
            ...
            oq.AddFetchMode("OptionStyle", NHibernate.FetchMode.Eager);
