...
namespace Application.Business.Erp.SupplyChain.MaterialHireMng.MaterialHireBalance.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class MatHireBalanceMaster : BaseMaster
    {
        ...
        private Iesi.Collections.Generic.ISet<MatHireBalanceOtherCostDtl> matBalOtherCostDetails = new Iesi.Collections.Generic.HashedSet<MatHireBalanceOtherCostDtl>();
        virtual public Iesi.Collections.Generic.ISet<MatHireBalanceOtherCostDtl> MatBalOtherCostDetails
        {
        ...
        virtual public void AddMatBalOtherCostDetails(MatHireBalanceOtherCostDtl detail)
        {
            detail.Master = this;
