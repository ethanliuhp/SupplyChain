...
using Application.Business.Erp.SupplyChain.MaterialHireMng.MaterialHireStockIn.Domain;
...
using Application.Business.Erp.SupplyChain.MaterialHireMng.MaterialHireRelation;
...
namespace Application.Business.Erp.SupplyChain.MaterialHireMng.Service
{
    ...
    public class MaterialHireStockInSrv : BaseService, IMaterialHireStockInSrv
    {
        ...
        private IMaterialHireSupplyOrderSrv supplyOrderSrv;

        public IMaterialHireSupplyOrderSrv SupplyOrderSrv
        {
        ...
        public IList GetStockIn(ObjectQuery objectQuery)
        {
            ...
            return Dao.ObjectQuery(typeof(MatHireStockIn), objectQuery);
        }


        public MatHireStockIn GetStockInById(string id)
        {
            ...
            {
                return list[0] as MatHireStockIn;
            }
            return null;
        }

        public MatHireStockIn GetStockInByCode(string Code, string special, string projectId)
        {
            ObjectQuery oq = new ObjectQuery();
        ...
        public MatHireStockIn GetStockInByCode(string Code, string projectId)
        {
            ObjectQuery oq = new ObjectQuery();
            oq.AddCriterion(Expression.Eq("Code", Code));
            oq.AddCriterion(Expression.Eq("ProjectId", projectId));
        ...
        public MatHireStockInDtl GetStockInDtl(string stockInDtlId)
        {
            ObjectQuery oq = new ObjectQuery();
            oq.AddCriterion(Expression.Eq("Id", stockInDtlId));
            oq.AddFetchMode("Master", FetchMode.Eager);
            IList list = Dao.ObjectQuery(typeof(MatHireStockInDtl), oq);

            if (list != null && list.Count > 0)
            {
                return list[0] as MatHireStockInDtl;
            }
            return null;
        }
        ...
        {
            return Dao.ObjectQuery(typeof(MatHireStockInDtl), oq);
        }
        ...
        public IList GetStockInDtlByBal(ObjectQuery oq, string projectId, string supplierId)
        {
            ...
            foreach (MatHireStockInDtl dtl in list)
            {
        ...
        {
            return Dao.ObjectQuery(typeof(MatHireStockInDtlSeq), oq);
        }
        ...
        /// <returns></returns>
        [TransManager]
        public MatHireStockIn SaveStockIn(MatHireStockIn obj, IList movedDtlList)
        {
            //操作过磅单材料关联表
            //SaveWeightBillRelation(obj.Details.OfType<MatHireStockInDtl>().ToList(), movedDtlList.OfType<StockInDtl>().ToList());
            obj.LastModifyDate = DateTime.Now;
            if (obj.Id == null)
            {
                if (obj.Special == "土建")
                {
                    obj.Code = GetCode(typeof(MatHireStockIn), obj.ProjectId, obj.MaterialCategory.Abbreviation);
                }
                else if (obj.Special == "安装")
                {
                    obj.Code = GetCode(typeof(MatHireStockIn), obj.ProjectId, obj.ProfessionCategory);
                }
                ...
                obj = SaveByDao(obj) as MatHireStockIn;
                //新增时修改前续单据的引用数量
                foreach (MatHireStockInDtl dtl in obj.Details)
                {
            ...
            else
            {
                ...
                obj = SaveOrUpdateByDao(obj) as MatHireStockIn;
                foreach (MatHireStockInDtl dtl in obj.Details)
                {
                    DailyPlanDetail forwardDtl = GetDailyPlanDetailById(dtl.ForwardDetailId);
                    if (forwardDtl != null)
                ...
                //修改时对于删除的明细 删除引用数量
                foreach (MatHireStockInDtl dtl in movedDtlList)
                {
                    DailyPlanDetail forwardDtl = GetDailyPlanDetailById(dtl.ForwardDetailId);
                    if (forwardDtl != null)
                    {
        ...
        /// <returns></returns>
        [TransManager]
        public bool DeleteStockIn(MatHireStockIn obj)
        {
        ...
        public IList GetStockInRed(ObjectQuery oq)
        {
            ...
            return Dao.ObjectQuery(typeof(MatHireStockInRed), oq);
        }

        public MatHireStockInRed GetStockInRedById(string stockInRedId)
        {
            ObjectQuery oq = new ObjectQuery();
            oq.AddCriterion(Expression.Eq("Id", stockInRedId));
            IList list = GetStockInRed(oq);
            if (list == null || list.Count == 0) return null;
            return list[0] as MatHireStockInRed;
        }

        public MatHireStockInRed GetStockInRedByCode(string code, string special, string projectId)
        {
            ObjectQuery oq = new ObjectQuery();
            oq.AddCriterion(Expression.Eq("Code", code));
            oq.AddCriterion(Expression.Eq("Special", special));
        ...
        public MatHireStockInRed GetStockInRedByCode(string code, string projectId)
        {
            ObjectQuery oq = new ObjectQuery();
            oq.AddCriterion(Expression.Eq("Code", code));
            oq.AddCriterion(Expression.Eq("ProjectId", projectId));
        ...
        [TransManager]
        public MatHireStockInRed SaveStockInRed(MatHireStockInRed obj, IList movedDtlList)
        {
            obj.LastModifyDate = DateTime.Now;
            if (obj.Id == null)
            {
                if (obj.Special == "土建")
                {
                    obj.Code = GetCode(typeof(MatHireStockInRed), obj.ProjectId, obj.MaterialCategory.Abbreviation);
                }
                else if (obj.Special == "安装")
                {
                    obj.Code = GetCode(typeof(MatHireStockInRed), obj.ProjectId, obj.ProfessionCategory);
                }
                obj.RealOperationDate = DateTime.Now;
                if (obj.DocState == DocumentState.InAudit || obj.DocState == DocumentState.InExecute)
                {
                ...
                obj = SaveByDao(obj) as MatHireStockInRed;
                //新增时修改前续单据的引用数量
                foreach (MatHireStockInRedDtl dtl in obj.Details)
                {
                    MatHireStockInDtl forwardDtl = GetStockInDtl(dtl.ForwardDetailId);
                    forwardDtl.RefQuantity = forwardDtl.RefQuantity + Math.Abs(dtl.Quantity);
                    dao.Save(forwardDtl);
            ...
            else
            {
                ...
                obj = SaveOrUpdateByDao(obj) as MatHireStockInRed;
                foreach (MatHireStockInRedDtl dtl in obj.Details)
                {
                    MatHireStockInDtl forwardDtl = GetStockInDtl(dtl.ForwardDetailId);
                    if (dtl.Id == null)
                ...
                //修改时对于删除的明细 删除引用数量
                foreach (MatHireStockInRedDtl dtl in movedDtlList)
                {
                    MatHireStockInDtl forwardDtl = GetStockInDtl(dtl.ForwardDetailId);
                    forwardDtl.RefQuantity = forwardDtl.RefQuantity - Math.Abs(dtl.Quantity);
                    dao.SaveOrUpdate(forwardDtl);
        ...
        [TransManager]
        public MatHireStockInRed SaveStockInRed(MatHireStockInRed obj)
        {
            obj.LastModifyDate = DateTime.Now;
            if (obj.Id == null)
            {
        ...
        [TransManager]
        public bool DeleteStockInRed(MatHireStockInRed obj)
        {
            if (obj.Id == null) return true;
            //删除明细时 删除引用数量
            foreach (MatHireStockInRedDtl dtl in obj.Details)
...
//        }
        ...
        #region 验收结算单提交处理
        private IMaterialHireStockOutSrv stockOutSrv;
        public IMaterialHireStockOutSrv StockOutSrv
        {
        ...
        //            {
        //                if (stockInDtl.Price != stockInBalDetail.Price)//核算价格与入库价格存在差异,一笔调差
        //                {
        //                    if (bFirst)
        //                    {
        //                        bFirst = false;
        ...
        //[TransManager]
        //public void DiffMonthAdjust(MatHireStockInDtl oStockInDtl, StockInBalDetail oStockInBalDetail, StockInBalMaster stockInBalMaster, StockIn oStockInMasterAdjustPrice, StockOut oStockOutMasterAdjustPrice)
        //{
        ...
        //[TransManager]
        //public void DiffMonthAdjust(MatHireStockInDtl oStockInDtl, StockInBalDetail oStockInBalDetail, StockInBalMaster stockInBalMaster, StockIn oStockInMasterTall, StockInRed oStockInRedMasterTall, StockIn oStockInMasterAdjustPrice, StockOut oStockOutMasterAdjustPrice)
        //{
        //    if (oStockInDtl != null && oStockInBalDetail != null)
        //    {
        //        string sStockInDtlID = oStockInDtl.Id;
        ...
        //                    #region 入库蓝单
        //                    //明细
        //                    MatHireStockInDtl oRemainStockInDtlHand = CopyToStockInDtl(oStockInDtl);
        //                    oRemainStockInDtlHand.Id = null;
        //                    oRemainStockInDtlHand.Price = dDiffPrice;//价格
        //                    oRemainStockInDtlHand.ConfirmPrice = dDiffPrice;
        //                    oRemainStockInDtlHand.Quantity = 0;// dQuantity;// oStockOutDtlHand.Quantity;//数量
        ...
        public void UndoAdjustPrice(IList lstStock)
        {
            ...
            if (lstStock != null && lstStock.Count > 0)
            {
                if (lstStock.Count > 1)
                {
                    MatHireStockIn oStockIn = lstStock[1] as MatHireStockIn;
                    if (oStockIn != null)
                    {
                ...
                if (lstStock.Count > 0)
                {
                    MatHireStockInRed oStockInRed = lstStock[0] as MatHireStockInRed;
                    if (oStockInRed != null)
                    {
                ...
                if (lstStock.Count > 2)
                {
                    MatHireStockOut oStockOut = lstStock[2] as MatHireStockOut;
                    if (oStockOut != null)
                    {
                ...
                if (lstStock.Count > 3)
                {
                    MatHireStockIn oStockIn = lstStock[3] as MatHireStockIn;
                    if (oStockIn != null)
                    {
                        DeleteStockIn(oStockIn);
                    }
        ...
        /// <param name="oStockInDtl"></param>
        /// <returns></returns>
        public MatHireStockInRedDtl CopyToStockInRedDtl(MatHireStockInDtl oStockInDtl)
        {
            MatHireStockInRedDtl oStockInRedDtlHand = new MatHireStockInRedDtl();
            if (oStockInDtl != null)
            {
                #region 子表
        ...
        ///// <returns></returns>
        //public MatHireStockIn CopyToStockInMaster(MatHireStockInDtl oStockInDtl, StockInBalMaster oStockInBalMaster)
        //{
        ...
        public MatHireStockInDtl CopyToStockInDtl(MatHireStockInDtl oStockInDtl)
        {
            // StockIn oStockInHandle = new StockIn();
            MatHireStockInDtl oStockInDtlHandle = new MatHireStockInDtl();
            if (oStockInDtl != null)
            {
        ...
        public MatHireStockOutDtl CopyToStockOutDtl(MatHireStockInDtl oStockInDtl)
        {
            MatHireStockOutDtl oStockOutDtlHandle = new MatHireStockOutDtl();
            if (oStockInDtl != null)
            {
        ...
        //public MatHireStockOut CopyToStockOutMaster(MatHireStockInDtl oStockInDtl, StockInBalMaster oStockInBalMaster)
        //{
        ...
        public IList GetStockInDtlByID(string sStockInDtlID)
        {
            ...
            return dao.ObjectQuery(typeof(MatHireStockInDtl), oQuery);
        ...
        /// <returns></returns>
        public MatHireStockIn GetStockInByStockInDtlID(string sID)
        {
            ISession session = CallContext.GetData("nhsession") as ISession;
            IDbConnection cnn = session.Connection;
            IDbCommand command = cnn.CreateCommand();
            MatHireStockIn oStockIn = null;
            ...
            if (!string.IsNullOrEmpty(sStockOutID))
            {
                ...
                IList list = dao.ObjectQuery(typeof(MatHireStockIn), oQuery);
                if (list != null && list.Count > 0)
                {
                    oStockIn = list[0] as MatHireStockIn;
                }
            }
            return oStockIn;
        ...
        private bool UpdateStockOut(string stockInDtlId, decimal price)
        {
            ...
            foreach (MatHireStockOutDtlSeq stockOutDtlSeq in list)
            {
                //更新出库时序表的单价
            ...
            if (StockOutDtlIdList.Count > 0)
            {
                ...
                {
                    MatHireStockOutDtl stockOutDtl = StockOutSrv.GetStockOutDtlByIdWithDetails(stockOutDtlId);
                    if (stockOutDtl == null)
                    {
                    ...
                    decimal money = 0M;
                    foreach (MatHireStockOutDtlSeq stockOutDtlSeq in stockOutDtl.StockOutDtlSeqList)
                    {
            ...
            if (StockOutIdList.Count > 0)
            {
                ...
                {
                    MatHireStockOut stockOut = StockOutSrv.GetStockOutById(stockOutId);
                    decimal money = 0M;
                    foreach (MatHireStockOutDtl stockOutDtl in stockOut.Details)
                    {
        ...
        private bool UpdateStockRelation(string stockInDtlId, decimal price)
        {
            ...
            if (list == null || list.Count == 0) return true;
            foreach (MatHireStockRelation sr in list)
            {
                sr.Price = price;
        ...
        //}
        [TransManager]
        public MatHireStockInRedDtl CopyStockInRedDtl(MatHireStockInDtl oStockInDtl)
        {
            MatHireStockInRedDtl oStockInRedDtl = null;
            if (oStockInDtl != null)
            {
                oStockInRedDtl = new MatHireStockInRedDtl();
        ...
        //[TransManager]
        //public MatHireStockOutRed CopyStockOutRedMaster(StockInBalRedMaster oStockInBalRedMaster, StockOut oStockOut)
        //{
        //    StockOutRed oStockOutRed = null;
        //    if (oStockOut != null)
        //    {
        ...
        //}
        [TransManager]
        public MatHireStockOutRedDtl CopyStockOutRedDtl(MatHireStockOutDtl oStockOutDtl)
        {
            MatHireStockOutRedDtl oStockOutRedDtl = null;
            if (oStockOutDtl != null)
            {
                oStockOutRedDtl = new MatHireStockOutRedDtl();
        ...
        private MatHireStockIn GetStockInByForwardID(string sForwardBillId)
        {

            ObjectQuery oQuery = new ObjectQuery();
            oQuery.AddCriterion(Expression.Eq("ForwardBillId", sForwardBillId));
            oQuery.AddFetchMode("Details", FetchMode.Eager);
            IList lst = dao.ObjectQuery(typeof(MatHireStockIn), oQuery);
            return (lst == null || lst.Count == 0) ? null : lst[0] as MatHireStockIn;
        }
        private MatHireStockOut GetStockOutByForwardID(string sForwardBillId)
        {
            ...
            return (lst == null || lst.Count == 0) ? null : lst[0] as MatHireStockOut;
        }
        /// <summary>
        /// 删除验收结算单红单
        /// </summary>
        ...
        {
            return dao.ObjectQuery(typeof(MatHireStockRelation), oq);
        }
        ...
        {
            oq.AddFetchMode("Details", FetchMode.Eager);
            return Dao.ObjectQuery(typeof(MatHireSupplyOrderMaster), oq);
        }
