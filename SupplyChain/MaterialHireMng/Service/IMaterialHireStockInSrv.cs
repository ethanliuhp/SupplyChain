...
namespace Application.Business.Erp.SupplyChain.MaterialHireMng.Service
{
  /// <summary>
    /// 入库单服务
    /// </summary>
    public interface  IMaterialHireStockInSrv : IBaseService
    {
        //IDao Dao { get; set; }
        ...
        /// <returns></returns>
        MatHireStockIn GetStockInByCode(string Code, string special, string projectId);
        MatHireStockIn GetStockInByCode(string Code, string projectId);
        /// <summary>
        /// 通过ID查询入库单
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        MatHireStockIn GetStockInById(string id);

        string GetStockInID(string id);
        DateTime GetServerDateTime();
        bool CheckServerDateTime();

        MatHireStockInDtl GetStockInDtl(string stockInDtlId);
      ...
      //  IList GetStockInDtlLst(StockInBalDetail stockInBalDetail);
        ...
        /// <returns></returns>
       // IList GetStockInDtlLst(List<MatHireStockInBalDetail> stockInBalDetailLst);
        ...
        /// <returns></returns>
        bool DeleteStockIn(MatHireStockIn obj);
        ...
        /// <returns></returns>
        MatHireStockIn SaveStockIn(MatHireStockIn obj, IList movedDtlList);
        #endregion
        ...
        /// <returns></returns>
        MatHireStockInRed GetStockInRedById(string stockInRedId);
        ...
        /// <param name="code"></param>
        /// <returns></returns>
        MatHireStockInRed GetStockInRedByCode(string code, string special, string projectId);
        MatHireStockInRed GetStockInRedByCode(string code, string projectId);
        /// <summary>
        /// 保存收料入库红单
        /// </summary>
        /// <param name="obj"></param>
        /// <param name="movedDtlList"></param>
        /// <returns></returns>
        MatHireStockInRed SaveStockInRed(MatHireStockInRed obj, IList movedDtlList);
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        bool DeleteStockInRed(MatHireStockInRed obj);
        #endregion
   ...
   //     bool DeleteStockInBalRedMaster(StockInBalRedMaster obj);
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        MatHireStockInRed SaveStockInRed(MatHireStockInRed obj);
        /// <summary>
        /// 提交调价单
        /// </summary>
        /// <param name="obj"></param>
