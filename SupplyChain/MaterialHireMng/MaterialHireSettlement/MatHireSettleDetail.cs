...
namespace Application.Business.Erp.SupplyChain.MaterialHireMng.MaterialHireSettlement
{
    /// <summary>
    /// 设备来源
    /// </summary>
    ...
    /// </summary>
    [Serializable]
    public class MatHireSettleDetail : BaseDetail
    {
        ...
        private Iesi.Collections.Generic.ISet<MatHireSubjectDetail> materialSubjectDetails = new Iesi.Collections.Generic.HashedSet<MatHireSubjectDetail>();
        virtual public Iesi.Collections.Generic.ISet<MatHireSubjectDetail> MaterialSubjectDetails
        {
        ...
        virtual public void AddSubjectDetail(MatHireSubjectDetail detail)
        {
