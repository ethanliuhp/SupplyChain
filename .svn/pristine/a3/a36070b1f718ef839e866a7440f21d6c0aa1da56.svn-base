...
namespace Application.Business.Erp.SupplyChain.Client.Basic.CommonClass
{
    public class CommonUtil
    {
        ...
        /// 设置电子签名
        /// </summary>
        /// <param name="flexGrid">flexGrid表格对象</param>
        /// <param name="perId">电子签名人的perId</param>
        /// <param name="rowindex">设置电子签名的行</param>
        /// <param name="colIndex">设置电子签名的列</param>
        public static void SetFlexSign(CustomFlexGrid flexGrid, string perId, int rowindex, int colIndex)
        {
           
            Image image = null;
#if DEBUG
            image = Image.FromFile(@"C:\Users\Administrator\Desktop\电子签名1.png");
#else 
            IDocumentSrv documentSrv = StaticMethod.GetService("DocumentSrv") as IDocumentSrv;
