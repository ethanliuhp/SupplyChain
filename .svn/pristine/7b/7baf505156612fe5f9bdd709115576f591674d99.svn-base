...
{
    public partial class VStockOutSelector : TBasicDataView
    {
        ...
        public VStockOutSelector(EnumStockExecType execType)
        {
        ...
        void dgMaster_SelectionChanged(object sender, EventArgs e)
        {
            dgDetail.Rows.Clear();
            Clear();
            StockOut master = dgMaster.CurrentRow.Tag as StockOut;
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow var in this.dgDetail.Rows)
            {
                ...
                {
                    StockOutDtl dtl = var.Tag as StockOutDtl;
                    dtl.IsSelect = true;
                }               
            }
        ...
        void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                oq.AddCriterion(Expression.Eq("IsLimited", 1));
            }
            ...
            try
            {
                list = model.StockOutSrv.GetStockOut(oq);
                ShowMasterList(list);
            } catch (Exception ex)
            {
        ...
        private void ShowMasterList(IList masterList)
        {
            ...
            foreach (StockOut master in masterList)
            {
                ...
                dgMaster[colDgMasterIsLimited.Name, rowIndex].Value = (master.IsLimited == 1) ? "是" : "否";
