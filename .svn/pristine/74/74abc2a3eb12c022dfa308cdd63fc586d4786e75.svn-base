...
{
    public partial class VMaterialReturnSearchCon : BasicUserControl
    {
        private MMatRentalMng model = new MMatRentalMng();
        private VMaterialReturnSearchList searchList;
        private int returnType = 1;

        public VMaterialReturnSearchCon(VMaterialReturnSearchList searchList, int type)
        {
            InitializeComponent();
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            oq.AddCriterion(Expression.Eq("ReturnType", returnType));
            ...
            IList list = model.MatMngSrv.GetMaterialReturnMaster(oq);
