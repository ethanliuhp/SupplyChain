...
{
    public partial class VDetectionReceiptSearchCon : BasicUserControl
    {
        private MDetectionReceiptMng model = new MDetectionReceiptMng();
        private VDetectionReceiptSearchList searchList;

        public VDetectionReceiptSearchCon(VDetectionReceiptSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.DetectionReceiptSrv.GetDetectionReceipt(oq);
