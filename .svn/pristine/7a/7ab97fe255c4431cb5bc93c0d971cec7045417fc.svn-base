...
{
    public partial class VWasteMaterialApplySearchCon : BasicUserControl
    {
        private MWasteMaterialMng model = new MWasteMaterialMng();
        private VWasteMaterialApplySearchList searchList;
        public VWasteMaterialApplySearchCon(VWasteMaterialApplySearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.WasteMatSrv.GetWasteMatApply(oq);
