...
{
    public partial class VMaterialHireLedgerQuery1 : TBasicDataView
    {
        MMaterialHireMng model = new MMaterialHireMng();
        public VMaterialHireLedgerQuery1()
        {
            InitializeComponent();
            this.InitData();
            this.InitEvent();
        ...
        void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.MaterialHireMngSvr.GetMaterialHireLedgerMaster(condition, dtpDateBegin.Value.Date, projectInfo.Id);
