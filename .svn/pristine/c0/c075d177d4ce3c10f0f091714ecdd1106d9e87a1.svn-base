...
public partial class MainPage_MainPageBottomMap : PageBaseClass
{
    ...
    private void LoadPic(string projectId)
    {
        ...
        if (listProject.Count > 0)
        {
            ...
            //projectInfo.Code = "10100100051";
            string param = "Depart=" + projectInfo.Code;
            ...
            if (str != "")
            {
                ...
                //aUrl.HRef = "http://www.cscec3b.com:166/Cameral/Project.aspx?Depart=1484";
                btnPicUrl.Text = projectInfo.Code;
            }
            else
            {
    ...
    protected void btnPicUrl_Click(object sender, EventArgs e)
    {
        ...
        //Server.Transfer("MainPagecontent.aspx", true);
        //Server.Execute(url);
