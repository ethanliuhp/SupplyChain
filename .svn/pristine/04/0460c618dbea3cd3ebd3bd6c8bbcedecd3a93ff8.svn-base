...
{
    partial class VStockInBalSearchCon
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VStockInBalSearchCon));
