...
{
    public partial class VMaterialRentalOrderQuery : TBasicDataView
    {
        private MMatRentalMng model = new MMatRentalMng();
        CurrentProjectInfo projectInfo;
        public VMaterialRentalOrderQuery()
        {
            InitializeComponent();
            InitEvent();
            InitData();
        ...
        void dgDetail_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                MaterialRentalOrderMaster master = model.MatMngSrv.GetMaterialRentalOrderByCode(dgvCell.Value.ToString());
                VMaterialRentalOrder vmro = new VMaterialRentalOrder();
        ...
        void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                #endregion
                DataSet dataSet = model.MatMngSrv.MaterialRentalOrderQuery(condition);
        ...
        void btnSearchBill_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.MatMngSrv.ObjectQuery(typeof(MaterialRentalOrderMaster), oq);
            dgMaster.Rows.Clear();
        ...
        void ShowMasterList(IList list)
        {
            ...
            foreach (MaterialRentalOrderMaster master in list)
            {
                ...
                {
                    this.dgMaster[colSupplyInfoMaster.Name, i].Value = master.TheSupplierRelationInfo.SupplierInfo.Name;
