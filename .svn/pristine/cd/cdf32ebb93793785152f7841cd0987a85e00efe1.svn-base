...
{
    public partial class VWasteMaterialHandleSearchList : SearchList
    {
        private CWasteMaterialHandle cWsateMaterialOrder;
        public VWasteMaterialHandleSearchList(CWasteMaterialHandle cWasteMaterialOrder)
        {
            InitializeComponent();
            this.cWsateMaterialOrder = cWasteMaterialOrder;
            InitDgSearch();
        }
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (code != null)
            {
                cWsateMaterialOrder.Find(code.ToString(),ClientUtil.ToString(Id));
            }
        }
        ...
        public void RefreshData(IList lst)
        {
            //从Model中取数
            dgSearchResult.Rows.Clear();
            foreach (WasteMatProcessMaster obj in lst)
            {
                ...
                dr.Cells["RecycleUnit"].Value = obj.RecycleUnitName;
