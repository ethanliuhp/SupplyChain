...
{
    public partial class VDailyPlanSearchCon : BasicUserControl
    {
        private MDailyPlanMng model = new MDailyPlanMng();
        private VDailyPlanSearchList searchList;
        private EnumDailyType dailyType;

        public VDailyPlanSearchCon(VDailyPlanSearchList searchList,EnumDailyType dailyType)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            //区分专业
            oq.AddCriterion(Expression.Eq("Special", Enum.GetName(typeof(EnumDailyType), dailyType)));
            ...
            IList list = model.DailyPlanSrv.GetDailyPlan(oq);
