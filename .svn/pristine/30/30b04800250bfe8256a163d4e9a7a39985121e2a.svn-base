...
{
    public partial class VGatheringSearchCon : BasicUserControl
    {
        private MFinanceMultData model = new MFinanceMultData();
        private VGatheringSearchList searchList;
        ...
        public VGatheringSearchCon(VGatheringSearchList searchList, int gatheringType)
        {
            this.searchList = searchList;
            this.currGatheringType = gatheringType;
            InitializeComponent();            
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            oq.AddCriterion(Expression.Eq("IfProjectMoney", currGatheringType));
            ...
            IList list = model.FinanceMultDataSrv.GetGatheringMaster(oq);
            searchList.RefreshData(list, currGatheringType);
