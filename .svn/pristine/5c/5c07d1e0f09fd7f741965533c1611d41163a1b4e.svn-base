...
{
    public partial class VFactoringDataSearchList : SearchList
    {
        private CFactoringData ctrl;

        public VFactoringDataSearchList(CFactoringData ctrl)
        {
            InitializeComponent();
            this.ctrl = ctrl;
            InitDgSearch();
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            FactoringDataMaster master = dgSearchResult.Rows[e.RowIndex].Tag as FactoringDataMaster;
            if (master != null)
            {
                ctrl.Find(master.Code, master.Id);
            }
        }
        ...
        public void RefreshData(IList lst)
        {
            //从Model中取数
            dgSearchResult.Rows.Clear();
            foreach (FactoringDataMaster obj in lst)
            {
