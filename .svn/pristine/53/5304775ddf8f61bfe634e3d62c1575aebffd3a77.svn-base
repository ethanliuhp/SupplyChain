...
{
    public partial class VMaterialSettlementSearchCon : BasicUserControl
    {
        private MMaterialSettlementMng model = new MMaterialSettlementMng();
        private VMaterialSettlementSearchList searchList;

        public VMaterialSettlementSearchCon(VMaterialSettlementSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (txtSupplier.Text != "")
            {
                oq.AddCriterion(Expression.Eq("SupplierName", this.txtSupplier.Text));
            }
            ...
            IList list = model.MaterialSettlementSrv.GetMaterialSettlementMaster(oq);
