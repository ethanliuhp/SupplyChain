...
{
    public partial class VMaterialHireRepair : TBasicDataView
    {
        public IList Result;
        MatHireRepair materialRepair;
        public VMaterialHireRepair(Material material, IList list_RepairContent)
        {
            InitializeComponent();
        ...
        public void OpenMaterialRepair(IList list)
        {
            ...
            try
            {
                ...
                {
                    //显示数据
                    foreach (MatHireRepair materialRepair in list)
                    {
        ...
        private void GetMaterialRepair()
        {
            ...
            foreach (DataGridViewRow var in dgMatRepair.Rows)
            {
                ...
                materialRepair = new MatHireRepair();
