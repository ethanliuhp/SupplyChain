...
namespace Application.Business.Erp.SupplyChain.CostManagement.QWBS.Service
{
    ...
    public class QWBSSrv : IQWBSSrv
    {
        ...
        /// <returns></returns>
        [TransManager]
        public IList SaveQWBSRootNode(IList lst)
        {
            QWBSManage node = lst[0] as QWBSManage;
            ...
            {
                lst[i] = SaveQWBSManageTree(lst[i] as QWBSManage);
            }
        ...
        /// <returns></returns>
        [TransManager]
        public QWBSManage SaveQWBSManageTree(QWBSManage childNode)
        {
        ...
        public IList SaveQWBSManages(IList lst)
        {
            ...
            foreach (QWBSManage var in lst)
            {
                list.Add(SaveQWBSManageTree(var));
            }
            return list;
        }
        ...
        /// <returns></returns>
        [TransManager]
        public QWBSManage InsertOrUpdateQWBSManage(QWBSManage childNode)
        {
            childNode.UpdatedDate = DateTime.Now;
            if (childNode.Id == null)
            {
        ...
        public IList InsertOrUpdateQWBSManages(IList lst)
        {
            ...
            foreach (QWBSManage var in lst)
            {
                list.Add(InsertOrUpdateQWBSManage(var));
            }
            return list;
        }
        ...
        /// <returns></returns>
        [TransManager]
        public bool DeleteQWBSManage(QWBSManage pbs)
        {
            pbs = dao.Get(typeof(QWBSManage), pbs.Id) as QWBSManage;
            return nodeSrv.DeleteCategoryNode(pbs);
        }

        [TransManager]
        public bool DeleteQWBSManage(IList list)
        {
            foreach (QWBSManage node in list)
            {
                ObjectQuery oq = new ObjectQuery();
                oq.AddCriterion(Expression.Eq("ParentNode.Id", node.Id));
                IList listChild = dao.ObjectQuery(typeof(QWBSManage), oq);

                if (listChild.Count > 0)
                {
                    DeleteQWBSManage(listChild);
                }

                QWBSManage tempNode = dao.Get(typeof(QWBSManage), node.Id) as QWBSManage;
                if (tempNode != null)
                    dao.Delete(tempNode);
            }
            return true;
        ...
        /// <returns></returns>
        [TransManager]
        public QWBSManage MoveQWBSManage(QWBSManage pbs, QWBSManage toPbs)
        {
            ...
            {
                QWBSManage oldParent = dao.Get(typeof(QWBSManage), pbs.ParentNode.Id) as QWBSManage;
            ...
            list = dao.ObjectQuery(typeof(QWBSManage), oq);
            toPbs = list[0] as QWBSManage;
            ...
            if (listChild.Count > 0)
            {
                ...
                {
                    QWBSManage childNode = listChild[i] as QWBSManage;
        ...
        private void UpdateChildNodes(QWBSManage parentNode)
        {
            ObjectQuery oq = new ObjectQuery();
            oq.AddCriterion(Expression.Eq("Id", parentNode.Id));
            oq.AddFetchMode("ChildNodes", FetchMode.Eager);
            parentNode = dao.ObjectQuery(typeof(QWBSManage), oq)[0] as QWBSManage;
        ...
        {
            CategoryTree tree = treeService.GetCategoryTreeByType(typeof(QWBSManage));
        ...
        {
            //CategoryTree tree = InitTree("工程任务类型树", typeof(QWBSManage));
            ObjectQuery oq = new ObjectQuery();
        ...
        public IList GetQWBSManageByInstance(string projectId)
        {
            ...
            //oq.AddOrder(Order.Asc("Level"));
            //oq.AddOrder(Order.Asc("OrderNo"));
            //IList list = NodeSrv.GetInstanceNodesByObjectQuery(typeof(QWBSManage), oq);
            //return list;
            #endregion
            ...
            oq.AddOrder(Order.Asc("TaskLevel"));
            oq.AddOrder(Order.Asc("OrderNo"));
        ...
        public IList GetProjectTaskTypeByInstance(string projectId, IList listParentTaskType)
        {
            ...
            foreach (QWBSManage taskType in listParentTaskType)
            {
        ...
        /// </summary>
        [TransManager]
        public QWBSManage GetQWBSManage(QWBSManage orgCat)
        {
            QWBSManage opeOrg = new QWBSManage();
            ...
            IList lst = dao.ObjectQuery(typeof(QWBSManage), oq);
            if (lst.Count > 0)
            {
                opeOrg = lst[0] as QWBSManage;
                return opeOrg;
            }
            else
            {
                orgCat = SaveQWBSManageTree(orgCat);
                return orgCat;
            }
        }
        ...
        /// <param name="t"></param>
        /// <returns></returns>
        public IList GetQWBSManageAndJobs()
        {
            ObjectQuery oq = new ObjectQuery();
            oq.AddFetchMode("OperationJobs", NHibernate.FetchMode.Eager);
            //oq.AddFetchMode("ChildNodes", NHibernate.FetchMode.Eager);
            oq.AddOrder(Order.Asc("Level"));
            IList list = NodeSrv.GetNodesByObjectQuery(typeof(QWBSManage), oq);
            return list;
        }
        ...
        public IList GetOpeOrgAndJobsByInstance()
        {
            ...
            //foreach (QWBSManage childNode in listTree)
            //{
        ...
        public IList GetQWBSManages(Type t, ObjectQuery oq)
        {
        ...
        /// <param name="pbs"></param>
        /// <returns></returns>
        public IList GetALLChildNodes(QWBSManage pbs)
        {
        ...
        {
            return nodeSrv.GetCategoryNodeById(id, typeof(QWBSManage)) as QWBSManage;
        }
        ...
        /// <returns></returns>
        public IList GetQWBSManageRules(Type treeType, Type parentNodeType)
        {
        ...
        public IList GetGWBSTreesByInstance(string projectId)
        {
            ...
            ObjectQuery oq = new ObjectQuery();
            oq.AddCriterion(Expression.Eq("ProjectGUId", projectId));
            oq.AddCriterion(Expression.Eq("State", 1));
            //oq.AddOrder(Order.Asc("SysCode"));
            //oq.AddOrder(Order.Asc("CategoryNodeType"));
            oq.AddOrder(Order.Asc("Level"));
