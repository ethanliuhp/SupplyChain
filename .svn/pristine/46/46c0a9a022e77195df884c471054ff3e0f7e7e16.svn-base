...
{
    public partial class VExpensesSettleSearchList : SearchList
    {
        private CExpensesSettleMng cExpensesSettleMng;

        public VExpensesSettleSearchList(CExpensesSettleMng cExpensesSettleMng)
        {
            InitializeComponent();
            this.cExpensesSettleMng = cExpensesSettleMng;
            InitDgSearch();
        }
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ExpensesSettleMaster expensesMaster = dgSearchResult.Rows[e.RowIndex].Tag as ExpensesSettleMaster;
            if (expensesMaster != null)
            {
                cExpensesSettleMng.Find(expensesMaster.Code, expensesMaster.Id);
            }
        }
        ...
        public void RefreshData(IList lst)
        {
            ...
            foreach (ExpensesSettleMaster obj in lst)
            {
