...
{
    public partial class VEngineerChangeSearchList : SearchList
    {
        private CEngineerChangeMng cEngineerChangeMng;
        public VEngineerChangeSearchList(CEngineerChangeMng cEngineerChangeMng)
        {
            InitializeComponent();
            this.cEngineerChangeMng = cEngineerChangeMng;
            InitDgSearch();
        }
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (code != null)
            {
                cEngineerChangeMng.Find(code.ToString(),ClientUtil.ToString(Id));
            }
        }
        ...
        public void RefreshData(IList lst)
        {
            //从Model中取数
            dgSearchResult.Rows.Clear();
            foreach (EngineerChangeMaster obj in lst)
            {
