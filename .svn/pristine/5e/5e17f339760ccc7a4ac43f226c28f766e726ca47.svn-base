...
{
    public partial class VSpecialAccountSearchCon : BasicUserControl
    {
        private MSpecialAccount model = new MSpecialAccount();
        private VSpecialAccountSearchList searchList;
        public VSpecialAccountSearchCon(VSpecialAccountSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.SpecialCostSrv.GetSpecialAccount(oq);
