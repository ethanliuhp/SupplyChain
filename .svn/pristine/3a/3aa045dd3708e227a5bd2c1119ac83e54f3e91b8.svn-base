...
{
    public partial class VWasteMaterialHandleCon : BasicUserControl
    {
        private MWasteMaterialMng model = new MWasteMaterialMng();
        private VWasteMaterialHandleSearchList searchList;
        public VWasteMaterialHandleCon(VWasteMaterialHandleSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.WasteMatSrv.GetWasteMatHandle(oq);
