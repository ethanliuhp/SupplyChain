...
{
    public partial class VProInsRecordSearchCon : BasicUserControl
    {
        private MProInsRecordMng model = new MProInsRecordMng();
        private VProInsRecordSearchList searchList;
        public VProInsRecordSearchCon(VProInsRecordSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.ProfessionInspectionSrv.GetProfessionInspectionRecordPlan(oq);
