...
{
    public partial class VMaterialReturnQuery : TBasicDataView
    {
        MMatRentalMng model = new MMatRentalMng();
        public VMaterialReturnQuery()
        {
            InitializeComponent();
            InitData();
            InitEvent();
        ...
        void dgMaster_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                MaterialReturnMaster master = dgMaster.Rows[e.RowIndex].Tag as MaterialReturnMaster;
                //if()
                VMaterialReturn vMaterialReturn = new VMaterialReturn(1);
        ...
        void dgDetail_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex > -1 && e.ColumnIndex > -1)
            {
                ...
                {
                    VMaterialReturn vOrder = new VMaterialReturn(1);
                    vOrder.Start(billId);
                    vOrder.ShowDialog();
                }
            }
        ...
        void dgDetail_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                MaterialReturnMaster master = model.MatMngSrv.GetMaterialReturnByCode(ClientUtil.ToString(dgvCell.Value));
                //if()
                VMaterialReturn vMaterialReturn = new VMaterialReturn(1);
                vMaterialReturn.MatReturnMaster = master;
                vMaterialReturn.Preview();
        ...
        void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet dataSet = model.MatMngSrv.GetMaterialReturnMasterQuery(condition);
                ...
                foreach (DataRow dataRow in dataTable.Rows)
                {
                    ...
                    dgDetail[colProjectQuantity.Name, rowIndex].Value = dataRow["ProjectQuantity"].ToString();
        ...
        void btnSearchBill_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.MatMngSrv.ObjectQuery(typeof(MaterialReturnMaster), oq);
            dgMaster.Rows.Clear();
        ...
        void ShowMasterList(IList list)
        {
            ...
            foreach (MaterialReturnMaster master in list)
            {
        ...
        {
            dgDetailBill.Rows.Clear();
            MaterialReturnMaster master = dgMaster.CurrentRow.Tag as MaterialReturnMaster;
            if (master == null) return;
            foreach (MaterialReturnDetail dtl in master.Details)
            {
