...
{
    public partial class VIncomeSettlementSearchCon : BasicUserControl
    {
        private MIncomeSettlementMng model = new MIncomeSettlementMng();
        private VIncomeSettlementSearchList searchList;

        public VIncomeSettlementSearchCon(VIncomeSettlementSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.IncomeSettlementSrv.GetIncomeSettlementMaster(oq);
