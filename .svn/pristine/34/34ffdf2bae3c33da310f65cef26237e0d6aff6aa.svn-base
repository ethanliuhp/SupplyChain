...
{
    public partial class VTempDebitMngSearchCon : BasicUserControl
    {
        private MPenaltyDeductionMng service = new MPenaltyDeductionMng();
        private VTempDebitMngSearchList searchList;

        public VTempDebitMngSearchCon(VTempDebitMngSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            oq.AddCriterion(Expression.Like("PenaltyDeductionReason", "暂扣款"));
            oq.AddOrder(new Order("Code", false));
            oq.AddFetchMode("Details", FetchMode.Eager);
            IList list = service.ObjectQuery(typeof(PenaltyDeductionMaster), oq);
