...
public partial class MoneyManage_GatheringMng_master : System.Web.UI.Page
{
    string sMasterSQL;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sMasterSQL = string.Format("select  t.* from THD_GATHERINGMASTER t where CreatePerson='{0}' and IfProjectMoney={1} ", PublicClass.GetUseInfo(Session).CurrentPersinInfo.Id, GatheringType);
