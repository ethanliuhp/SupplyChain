...
{
    public class MeetingMngSrv : BaseService, IMeetingMngSrv
    {
        #region code生成方法
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public MeetingMng GetImpById(string id)
        {
        ...
        /// <returns></returns>
        public MeetingMng GetImpByCode(string code)
        {
            ObjectQuery objectQuery = new ObjectQuery();
...
(ProObjectRelaDocument item)
        ...
        public IList GetImp(ObjectQuery objectQuery)
        {
            ...
            return Dao.ObjectQuery(typeof(MeetingMng), objectQuery);
        }
        [TransManager]
        public MeetingMng saveImp(MeetingMng obj)
        {
            ...
            return SaveOrUpdateByDao(obj) as MeetingMng;
        }
        public DataSet MeetingQuery(string condition)
        {
            ISession session = CallContext.GetData("nhsession") as ISession;
            IDbConnection conn = session.Connection;
            IDbCommand command = conn.CreateCommand();
            string sql =
                @"SELECT t1.Id ,t1.MeetingStyle,t1.MeetingDate,t1.MeetingTopic,t1.MeetingRemark,t1.CreatePersonName,t1.CreateDate,t1.RealOperationDate
                From thd_Meetingmanage t1";
            sql += " where 1=1 " + condition + "order by t1.MeetingDate  asc ";
