<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Main.aspx.cs" Inherits="MoneyManage_FactoringData_Main" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        // 重新加载子表
        function reloadMaster(id,pageState){
            ifrMaster.attr("src","Master.aspx");
        }
