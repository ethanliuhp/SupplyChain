<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IntegratedInfoMain.aspx.cs" Inherits="IntegratedInfoMain"
    Title="ึ๗าณ" %>
...
<frameset cols="175,*" id="mainFrameSet" framespacing="4" frameborder="0">
        ...
        <frame scrolling="auto" id="frmContent" runat="server" src="MainPageContent.htm" marginwidth="0" marginheight="0" framespacing="0" />
</frameset>
</html>
