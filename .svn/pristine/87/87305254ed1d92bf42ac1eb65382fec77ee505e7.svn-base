...
{
    public partial class VSupplyPlanSearchCon : BasicUserControl
    {
        private MSupplyPlanMng model = new MSupplyPlanMng();
        private VSupplyPlanSearchList searchList;

        public VSupplyPlanSearchCon(VSupplyPlanSearchList searchList)
        {
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.SupplyPlanSrv.GetSupplyPlan(oq);
