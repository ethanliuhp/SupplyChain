...
<%--<frameset rows="80px,*" framespacing="0" frameborder="0">
   ...
   <frameset id="mainFrameSet" cols="15%,*" framespacing="0" frameborder="0"> 
        <frame src="Menu.aspx" id="frMenu" scrolling="auto" marginwidth="0" marginheight="0" framespacing="0"    ></frame>
