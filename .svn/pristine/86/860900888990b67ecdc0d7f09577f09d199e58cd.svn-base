...
{
    public partial class VStockInBalSelector : TBasicDataView
    {
        ...
        void dgMaster_SelectionChanged(object sender, EventArgs e)
        {
            dgDetail.Rows.Clear();
            Clear();
            StockInBalMaster master = dgMaster.CurrentRow.Tag as StockInBalMaster;
            ...
            foreach (StockInBalDetail dtl in master.Details)
            {
                ...
                dgDetail[colMoney.Name, rowIndex].Value = (dtl.Price * canUseQuantity);
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow var in this.dgDetail.Rows)
            {
                ...
                {
                    StockInBalDetail dtl = var.Tag as StockInBalDetail;
                    dtl.IsSelect = true;
                }               
            }
        ...
        void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                list = model.StockInSrv.GetStockInBalMaster(oq);
                ShowMasterList(list);
            } catch (Exception ex)
            {
