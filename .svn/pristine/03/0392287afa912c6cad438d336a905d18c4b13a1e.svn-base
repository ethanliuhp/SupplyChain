...
{
    public class CDSSViewFreeWrite
    {
        static IFramework framework;
        private string mainViewName = "决策报表录入";

        public CDSSViewFreeWrite(IFramework fw)
        {
            if (framework == null)
            {
                framework = fw;
        ...
        private void Find()
        {
            ...
            {
                VDSSViewFreeWrite mainView = new VDSSViewFreeWrite();
