...
{
    public partial class VStockBlockMaterialSearchCon : BasicUserControl
    {
        VStockBlockMaterialSearchList searchList;
        private MMaterialHireMng model = new MMaterialHireMng();
        public EnumMatHireType MatHireType;
        public VStockBlockMaterialSearchCon(VStockBlockMaterialSearchList oSearchList, EnumMatHireType MatHireType)
        {
            InitializeComponent();
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            IList list = model.MaterialHireMngSvr.ObjectQuery(typeof(MatHireStockBlockMaster),oq); //model.MaterialHireSupplyOrderSrv.GetStockBlockMasterOrder(oq);
