...
{
    public partial class VOverlayAmortizeSearchList : SearchList
    {
        private COverlayAmortizeMng cOverlayAmortizeMng;

        public VOverlayAmortizeSearchList(COverlayAmortizeMng cOverlayAmortizeMng)
        {
            InitializeComponent();
            this.cOverlayAmortizeMng = cOverlayAmortizeMng;
            InitDgSearch();
        }
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (code != null)
            {
                cOverlayAmortizeMng.Find(code.ToString(),ClientUtil.ToString(Id));
            }
        }
        ...
        public void RefreshData(IList lst)
        {
            ...
            foreach (OverlayAmortizeMaster obj in lst)
            {
