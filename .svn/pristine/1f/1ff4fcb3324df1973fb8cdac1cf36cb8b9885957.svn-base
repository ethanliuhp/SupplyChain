...
{
    public partial class VProjectTaskAccountBillSearchCon : BasicUserControl
    {
        private MProjectTaskAccount model = new MProjectTaskAccount();
        private VProjectTaskAccountBillSearchList searchList;

        public VProjectTaskAccountBillSearchCon()
        {
            InitializeComponent();
        ...
        public VProjectTaskAccountBillSearchCon(VProjectTaskAccountBillSearchList searchList)
        {
            InitializeComponent();
