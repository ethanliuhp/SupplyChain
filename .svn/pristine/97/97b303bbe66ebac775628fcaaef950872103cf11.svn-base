...
{
    public partial class VSupplyOrderSearchList : SearchList
    {
        private CSupplyOrderMng cSupplyOrder;

        public VSupplyOrderSearchList(CSupplyOrderMng cSupplyOrder)
        {
            InitializeComponent();
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                cSupplyOrder.Find(supplyMaster.Code, (EnumSupplyType)Enum.Parse(typeof(EnumSupplyType), supplyMaster.Special),supplyMaster.Id);
            }
        }
