...
{
    public partial class VMaterialHireLedgerQuery : TBasicDataView
    {
        MMaterialHireMng model = new MMaterialHireMng();
        public VMaterialHireLedgerQuery()
        {
            InitializeComponent();
            this.InitData();
            this.InitEvent();
        ...
        void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            DataSet dataSet = model.MaterialHireMngSvr.GetMaterialHireLedgerByCondition(condition);
            ...
            foreach (DataRow dataRow in dataTable.Rows)
            {
                ...
                if (washType == 0)
                {
                    ...
                    dgDetail[colType.Name, rowIndex].Value = "发料单";
