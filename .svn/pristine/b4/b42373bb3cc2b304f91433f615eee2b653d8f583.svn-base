...
{
    public partial class VWebSitePlanSearchList : SearchList
    {
        private CWebSitePlan cWebSitePlan;

        public VWebSitePlanSearchList(CWebSitePlan cWebSitePlan)
        {
            InitializeComponent();
            this.cWebSitePlan = cWebSitePlan;
            InitDgSearch();
        }
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (Enginner != null)
            {
                cWebSitePlan.Find(Enginner.ToString(), ClientUtil.ToString(Id));
            }
        }
