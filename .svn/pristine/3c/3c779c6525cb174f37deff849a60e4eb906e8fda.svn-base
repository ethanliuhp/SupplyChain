<%@ Page Language="C#" AutoEventWireup="true" CodeFile="master.aspx.cs" Inherits="MoneyManage_PaymentMng_master" %>
        ...
        <div id="divQuery" style=" width:100%; height:30px">
            <table cellpadding="0" cellspacing="0"  class="QueryTable">
                <tr class="QueryTableTr">
                    <td class="QueryTableTdLabel">付款日期:</td>
                 ...
                 Width="100%" Height="100%" EmptyDataText="没有符合条件数据"  >
                  ...
                  <Columns>
                            ...
                            <asp:BoundField HeaderText="序号"  HeaderStyle-Width="40"   >
                             ...
                             <asp:BoundField DataField="accounttitlename" HeaderText="付款类别"   >
                            </asp:BoundField>
                            <asp:BoundField DataField="supplierrelationname" HeaderText="单位"   >
                            </asp:BoundField>
                            <asp:BoundField DataField="bankaccountno" HeaderText="帐号"   >
                            </asp:BoundField>
                            <asp:BoundField DataField="bankname" HeaderText="开户行及行号"   >
                            </asp:BoundField>
                           <asp:BoundField DataField="summoney" HeaderText="金额(元)"  DataFormatString="{0:N2}"  >
                             </asp:BoundField>
                            
                             <asp:BoundField DataField="CreateDate" HeaderText="付款时间" DataFormatString="{0:yyyy-MM-dd}" >
                            </asp:BoundField>
