...
{
    public partial class VLaborSporadicSelect : TBasicDataView
    {
        ...
        private void InitForm()
        {
            ...
            txtSporadicType.SelectedItem = "零星用工";
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (flags)
            {
              IList lstPenalty=  CreatePenalty();

              curBillMaster = model.LaborSporadicSrv.SaveOrUpdateLaborSporadic(curBillMaster, lstPenalty);
        ...
        private IList CreatePenalty()
        {
            ...
            penaltyModel.Descript = "零星用工代工扣款";//备注
            ...
            foreach (DataGridViewRow var in this.dgDetail.Rows)
            {
                if ((bool)var.Cells[colSelect.Name].Value)
                {
                    ...
                    //penaltyDetail.Cause = detail.LaborDescript;// "零星用工代工扣款";
        ...
        void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                oq.AddCriterion(Expression.Or(Expression.Eq("LaborState", "零星用工"), Expression.Eq("LaborState", "计时派工")));
                oq.AddCriterion(Expression.Not(Expression.Eq("LaborState", "代工")));
            }
            try
            {
