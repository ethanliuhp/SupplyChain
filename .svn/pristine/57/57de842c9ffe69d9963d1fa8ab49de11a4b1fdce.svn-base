...
namespace Application.Business.Erp.SupplyChain.CostManagement.ProjectTaskAccountMng.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class ProjectTaskDetailAccount : BaseDetail
    {
        ...
        private decimal _addupAccountQuantity;
        /// <summary>
        /// 当次核算前累计核算工程量
        /// </summary>
        public virtual decimal AddupAccountQuantity
        {
            get { return _addupAccountQuantity; }
            set { _addupAccountQuantity = value; }
        }
        private decimal _addupAccountProgress;
        /// <summary>
        /// 当次核算前累计核算形象进度
        /// </summary>
        public virtual decimal AddupAccountProgress
        {
            get { return _addupAccountProgress; }
            set { _addupAccountProgress = value; }
        }

        private EnumMaterialFeeSettlementFlag _matFeeBlanceFlag;
        /// <summary>
        /// 料具结算标识，描述该工程任务是否需要与分包商结算料费（0：不结算、1：结算）。来自{工程任务确认明细}。
        /// </summary>
        public virtual EnumMaterialFeeSettlementFlag MatFeeBlanceFlag
        {
            get { return _matFeeBlanceFlag; }
            set { _matFeeBlanceFlag = value; }
        }
        ...
        /// <summary>
        /// 临时ID（不做map,用于在生成确认单时能快速找到前驱确认单）
        /// </summary>
    ...
    /// <summary>
    /// 描述该工程任务是否需要与分包商结算料费（0：不结算、1：结算）。来自{工程任务确认明细}。
    /// </summary>
    public enum ProjectTaskDtlMatBalanceFlag
    {
