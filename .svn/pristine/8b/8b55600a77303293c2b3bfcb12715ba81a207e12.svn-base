...
{
    public partial class VAccountMngSearchList : SearchList
    {
        private CAccountMng cAccountMng;
        private EnumAccountMng enumType;

        public VAccountMngSearchList(CAccountMng cAccountMng,EnumAccountMng enumType)
        {
            InitializeComponent();
            this.cAccountMng = cAccountMng;
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                cAccountMng.Find(oIndirectCostMaster.Code, enumType, oIndirectCostMaster.Id);
            }
        }
