...
{
    public partial class VLaborSporadicSearchCon : BasicUserControl
    {
        private MLaborSporadicMng model = new MLaborSporadicMng();
        private VLaborSporadicSearchList searchList;
        EnumLaborType LaborType;
        public VLaborSporadicSearchCon(VLaborSporadicSearchList searchList,EnumLaborType Type)
        {
