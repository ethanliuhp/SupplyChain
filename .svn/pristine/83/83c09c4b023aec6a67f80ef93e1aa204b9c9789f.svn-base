...
namespace Application.Business.Erp.SupplyChain.CostManagement.CostItemMng.Service
{
    public interface ICostAccountSubjectSrv
    {
        ...
        CostMonthReportChangeMatser GetCostMonthReportChangeMatser(string projectid, int year, int month);
        CostMonthReportChangeMatser SaveCostMonthReportChangeMatser(CostMonthReportChangeMatser cost);
    }
}
