...
{
    public partial class VSupplyPlanSearchList : SearchList
    {
        private CSupplyPlanMng cSupplyPlanMng;

        public VSupplyPlanSearchList(CSupplyPlanMng cSupplyPlanMng)
        {
            InitializeComponent();
            this.cSupplyPlanMng = cSupplyPlanMng;
            InitDgSearch();
        }
        ...
        void dgSearchResult_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (code != null)
            {
                cSupplyPlanMng.Find(code.ToString(),ClientUtil.ToString(Id));
            }
        }
        ...
        public void RefreshData(IList lst)
        {
            ...
            foreach (SupplyPlanMaster obj in lst)
            {
