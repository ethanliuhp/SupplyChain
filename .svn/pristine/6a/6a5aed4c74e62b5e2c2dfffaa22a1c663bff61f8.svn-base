<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowCustom.aspx.cs" Inherits="Show_ShowCustom" %>
...
<body>
    ...
    <div class="mainDiv">
        ...
        <div class="ContextDiv"  >
            <asp:GridView ID="gvPerson" runat="server" AutoGenerateColumns="False" DataKeyNames="id" Width="100%"
                ...
                <Columns>
                    <asp:TemplateField  ItemStyle-CssClass="colSelect">
                        ...
                        <ItemTemplate>
                            <input type="checkbox" value="选择" id='<%#Eval("id") %>' onclick="return Select('<%#Eval("id") %>',this);" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="id" DataField="suprelid" Visible="false" 
...
<ItemStyle CssClass="colContent_min"></ItemStyle>
                    ...
                    <asp:BoundField DataField="name" HeaderText="供应方" 
                        ItemStyle-CssClass="colContent_min">
<ItemStyle CssClass="colContent_min"></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="address" HeaderText="地址"  ItemStyle-CssClass="colContent_min">
                        <ItemStyle CssClass="colContent_min"></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="linkman" HeaderText="联系人"  ItemStyle-CssClass="colContent_min">
                        <ItemStyle CssClass="colContent_min"></ItemStyle>
                    </asp:BoundField>
                </Columns>
            </asp:GridView>
