<%@ Page Language="C#" AutoEventWireup="true" CodeFile="master.aspx.cs" Inherits="MoneyManage_CompanyAccountMng_master" %>
             ...
             <asp:GridView ID="gvMaster" runat="server" AutoGenerateColumns="false"   
                 Width="100%" Height="100%" EmptyDataText="没有符合条件数据"  >
                  ...
                  <Columns>
                           ...
                           <asp:BoundField DataField="money" HeaderText="金额(元)"  DataFormatString="{0:N2}"  >
                             </asp:BoundField>
                            <asp:BoundField DataField="CreatePersonName" HeaderText="制单人">
                                
                            </asp:BoundField>
                             <asp:BoundField DataField="CreateDate" HeaderText="截至时间" DataFormatString="{0:yyyy-MM-dd}" >
                            </asp:BoundField>
                            <asp:BoundField DataField="RealOperationDate" HeaderStyle-Width="150" HeaderText="制单时间" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" >
                            </asp:BoundField>
                             <asp:BoundField DataField="Year" HeaderText="年" Visible="false">
                                
                            </asp:BoundField>
                             <asp:BoundField DataField="Month" HeaderText="月"  Visible="false">
                             </asp:BoundField>
